...
class Agent:
    def __init__(self, model, role='e', temperature=None, observation=True):
...
class RSAgent(Agent):
    def __init__(self, model, role='e', temperature=None, observation=True, grobal_aleph = None, region_memory = None):
        super().__init__(model, role, temperature, observation)
